...
const Loading = () => {
  ...
  return (
    <>
      <div
        className={`absolute top-0 left-0 right-0  w-full bg-white z-50 duration-500 ease-in-out transition-all delay-300 ${isActive ? 'h-[50vh] opacity-100' : 'h-0 opacity-0'}`}
      ></div>
      <div
